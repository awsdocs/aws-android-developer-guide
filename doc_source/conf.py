...
project = u'Android Developer Guide'
...
project_basename = 'mobile/sdkforandroid/developerguide'

# This name is used as the manual / PDF name. Don't include the extension
# (.pdf) here.
man_name = 'aws-android-dg'
...
github_doc_url = 'https://github.com/awsdocs/aws-android-developer-guide/tree/master/doc_source'
...
#         ]
extra_navlinks = [
        ('API Reference', 'http://docs.aws.amazon.com/AWSAndroidSDK/latest/javadoc/'),
        ('GitHub', 'https://github.com/aws/aws-sdk-android'),
        ('Samples', 'https://github.com/awslabs/aws-sdk-android-samples'),
        ('Download SDK', 'http://sdk-for-android.amazonwebservices.com/latest/aws-android-sdk.zip'),
    ]
...
version_path_slug = 'sdkforandroid'

...
This repository contains source content for the official `AWS SDK for Android Developer Guide`_. The
source code for the `AWS SDK for Android`_ is also on GitHub, at https://github.com/aws/aws-sdk-android.
...
.. _`aws sdk for android developer guide`: http://docs.aws.amazon.com/mobile/sdkforandroid/developerguide/
.. _`aws sdk for android`: http://aws.amazon.com/mobile/sdk/
...
.. _issues: https://github.com/awsdocs/aws-android-developer-guide/issues
